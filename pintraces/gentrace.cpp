...
// KNOB<int> KnobTrigEndaddr(KNOB_MODE_WRITEONCE, "pintool",
//                        "trig_enaddr", "",
//                        "Address of trigger ending point. logging will be ended at this address.");
...
//	if ((((unsigned)addr) >=  KnobTrigAddr.Value()) && (((unsigned)addr) <= KnobTrigEndaddr.Value())){
